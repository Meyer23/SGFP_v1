...
namespace CapaPresentacion.Reportes
{
    public partial class FrmRptRanking : Form
    {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                this.sp_Ranking_Ventas_ProductoTableAdapter.Fill(this.dS_Reportes.sp_Ranking_Ventas_Producto, dtpFechaD.Value, dtpFechaH.Value, "", "ZZZZZZZZ");
            }
            else
            {
                this.sp_Ranking_Ventas_ProductoTableAdapter.Fill(this.dS_Reportes.sp_Ranking_Ventas_Producto, dtpFechaD.Value, dtpFechaH.Value, comboCategorias.Text.ToString(), comboCategorias.Text.ToString());
            }
