...
{
    public partial class FrmAnularNCEmitidas : Form
    {
        private int _IdNCEmitida;
        public FrmAnularNCEmitidas(int IdNCRecibida = 0)
        {
            _IdNCEmitida = IdNCRecibida;
            InitializeComponent();
            CargarMotivos();
        }
        ...
        private void BtnAnular_Click(object sender, EventArgs e)
        {
            ...
            bool Respuesta = new CN_NotasCreditoEmitidas().AnularNota(_IdNCEmitida, ComboMotivos.Text.ToString(), out Mensaje);
